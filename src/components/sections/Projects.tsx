      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          >
            <div className="flex space-x-6 pb-4 px-4" style={{ width: 'max-content' }}>
              {projects.map((project) => (
                <div
                  key={project.id}
                  className="flex-shrink-0 w-80 bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 flex flex-col transform hover:-translate-y-2"
                >
                  <div 
          ...
          <button
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white rounded-full shadow-lg p-3 hover:bg-gray-50 transition-colors z-10"
          >
          ...
          <button
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white rounded-full shadow-lg p-3 hover:bg-gray-50 transition-colors z-10"
          >
            <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
